...
if ( ! defined('MYLS_VERSION') )     define('MYLS_VERSION','7.9.18.105');
...
register_activation_hook( __FILE__, function() {
	// Ensure the Search & Replace undo snapshots table exists.
	$sr_ajax = MYLS_PATH . 'admin/tabs/bulk/_search-replace-ajax.php';
	if ( file_exists( $sr_ajax ) ) {
		require_once $sr_ajax;
		if ( function_exists( 'myls_sr_ensure_snapshots_table' ) ) {
